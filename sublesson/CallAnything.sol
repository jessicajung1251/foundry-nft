...
contract CallAnything {
    ...
    function transfer(uint256 someAddress, uint256 amount) public {
    ...
    function getSelectorOne() public pure return(bytes4 selector) {
    ...
    // this turns it into the selector for us vs encodeWithSelector where we encode the selector ourselves
...
// To be sure of what our transaction is doing:
